class SpreeVendorsHooks < Spree::ThemeSupport::HookListener
  ...
  insert_before :admin_product_form_meta,    :partial => 'admin/products/product_vendor_url'

  insert_after :admin_order_show_details,    :partial => 'admin/products/product_vendor_order'
